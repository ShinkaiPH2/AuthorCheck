...
export const HelpCircleIcon = ({ size = 20, className = '' }: IconProps) => {
  return (
    <svg
      width={size}
      height={size}
...
export const RobotIcon = ({ size = 20, className = '' }: IconProps) => {
  return (
    <svg
      width={size}
      height={size}
...
export const LightbulbIcon = ({ size = 20, className = '' }: IconProps) => {
  return (
    ...
    >
      ...
      <path d="M12 21c0-1 1-2 2-2s2-1 2-2-1-2-2-2-2 1-2 2-1 2-2 2-2 1-2 2 1 2 2 2z" />
    </svg>
  );
};
...
export const TestTubeIcon = ({ size = 20, className = '' }: IconProps) => {
  return (
    <svg
      width={size}
      height={size}
